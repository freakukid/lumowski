...
const virtualWindow = useVirtualWindow<DynamicInventoryItem>({
  ...
  // Sync fetched items to the global store so the cashier page can access them
  // for cart display and calculations (prices, names, quantities, etc.)
...
/**
 * Handles item click - only toggles if item is in stock.
 */
